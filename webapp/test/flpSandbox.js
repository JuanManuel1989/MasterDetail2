			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"loginlogin-display": {
								"semanticObject": "loginlogin",
								"action": "display",
								"description": "Master Detail App",
								"title": "Master Detail App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=login.login",
									"url": sap.ui.require.toUrl("login/login")
								}
							}
						}
					}
